function setupPlaneMesh(n, options) {
	...
	for (var attr in options) { basic_options[attr] = options[attr]; }

	size = basic_options.size;
	color = basic_options.color;
	translation = basic_options.translation;
	textured = basic_options.textured;
